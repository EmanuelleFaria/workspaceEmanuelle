...
public class DesafioWhile {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Incremente no mesmo código:
		 * O nome deve ter um sobrenome
		 * No final exiba o sobrenome
		 */
		
		String nome = JOptionPane.showInputDialog("Digite seu nome e sobrenome:").toUpperCase();
		
		while (nome.length()<5 || nome.length()>20 || nome.contains(" ")==false){
			nome = JOptionPane.showInputDialog("Digite o nome e sobrenome novamente contendo entre 5 a 20 caracteres:").toUpperCase();
		}
